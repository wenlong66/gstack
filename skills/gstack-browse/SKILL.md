...
${CLAUDE_PLUGIN_ROOT}/bin/gstack-timeline-log '{"skill":"browse","event":"started","branch":"'"$_BRANCH"'","session":"'"$_SESSION_ID"'"}' 2>/dev/null &
_HAS_ROUTING="no"
...
`$B` is the browse binary (resolved from `$_ROOT/${CLAUDE_PLUGIN_ROOT}/browse/dist/browse` or `${CLAUDE_PLUGIN_ROOT}/browse/dist/browse`).
