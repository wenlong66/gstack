...
${CLAUDE_PLUGIN_ROOT}/bin/gstack-timeline-log '{"skill":"benchmark-models","event":"started","branch":"'"$_BRANCH"'","session":"'"$_SESSION_ID"'"}' 2>/dev/null &
_HAS_ROUTING="no"
...
```bash
BIN="$HOME/${CLAUDE_PLUGIN_ROOT}/bin/gstack-model-benchmark"
[ -x "$BIN" ] || BIN="${CLAUDE_PLUGIN_ROOT}/bin/gstack-model-benchmark"
